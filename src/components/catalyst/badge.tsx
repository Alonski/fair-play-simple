...
const colors = {
  ...
  // App custom colors
  'partner-a': 'bg-partner-a/15 text-partner-a group-data-hover:bg-partner-a/25 dark:bg-partner-a/10 dark:group-data-hover:bg-partner-a/20',
  'partner-b': 'bg-partner-b/15 text-partner-b group-data-hover:bg-partner-b/25 dark:bg-partner-b/10 dark:group-data-hover:bg-partner-b/20',
  accent: 'bg-accent/15 text-accent group-data-hover:bg-accent/25 dark:bg-accent/10 dark:group-data-hover:bg-accent/20',
}
