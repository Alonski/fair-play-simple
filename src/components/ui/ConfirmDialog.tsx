      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-4 right-4 top-1/2 -translate-y-1/2 md:left-1/2 md:-translate-x-1/2 md:w-full md:max-w-sm bg-white rounded-2xl shadow-soft-lg z-[61] p-6"
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                onClick={onCancel}
                className="flex-1 px-4 py-2.5 bg-gray-100 text-concrete font-display font-bold rounded-xl text-sm hover:bg-gray-200 transition-colors"
              >
                {cancelLabel}
              </button>
            </div>
